...
@Autonomous(name = "B_0+4+sub", group = "autonomous", preselectTeleOp = "Teleop Live")
public class fourSampleAutoR extends LiveAutoBase {

    AutoSample auto;
    @Override
    public void on_init() {
        auto = new AutoSample(robot, 0.75, 0.5);
        robot.led_control.alliance = LEDConst.RED;
        auto.sampleInit();
